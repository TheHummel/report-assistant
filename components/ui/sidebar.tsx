  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'relative w-[var(--sidebar-width)] bg-transparent ease-linear',
...
function SidebarRail({ className, ...props }: React.ComponentProps<'div'>) {
  ...
  React.useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const newWidth = startWidthRef.current + deltaX / 16;
  ...
  return (
    <div
      ...
      className={cn(
        'absolute inset-y-0 -right-1 z-20 w-2 cursor-col-resize transition-colors hover:bg-gray-300/50 active:bg-blue-400/50 sm:flex',
        isDragging && 'bg-blue-400/50',
        className
      )}
      {...props}
    >
      <div className="absolute inset-y-0 left-1/2 w-px -translate-x-1/2 bg-gray-200 transition-colors hover:bg-gray-400" />
    </div>
  );
}
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        'outline-hidden absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground ring-sidebar-ring transition-transform peer-hover/menu-button:text-sidebar-accent-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
        // Increases the hit area of the button on mobile.
        'after:absolute after:-inset-2 md:after:hidden',
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        'outline-hidden flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 text-sidebar-foreground ring-sidebar-ring aria-disabled:pointer-events-none aria-disabled:opacity-50 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground',
